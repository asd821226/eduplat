...
/**
 * Assignqus Controller
 * @author 黄清泉
 * @date 2013-3-13
 */
@Controller
@RequestMapping("/security/finance/assignqus")
public class AssignqusController {
	 ...
	 */
	@RequestMapping("view")
	public Page<Assignqus> view(
			@PageableDefaults(sort = { "id" }, sortDir = Direction.DESC) Pageable pageable,
			HttpServletRequest request) {
		
		List<PropertyFilter> filters = PropertyFilters.build(request);
		
		return financeManager.searchAssignqusPage(pageable, filters);
	}
