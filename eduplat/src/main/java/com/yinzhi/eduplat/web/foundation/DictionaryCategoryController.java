 ...
 */
@Controller
@RequestMapping("/security/foundation/dictionary-category")
public class DictionaryCategoryController {
	...
	/**
	 * 
	 * 保存或更新字典类别,保存成功后重定向到:security/foundation/dictionary-category/view
	 * 
	 * @param entity 实体信息
	...
	public String save(@ModelAttribute("entity") DictionaryCategory entity,String parentId,RedirectAttributes redirectAttributes) {
		...
		return "redirect:/security/foundation/dictionary-category/view";
	}
	
	/**
	 * 
	 * 读取字典类别,返回security/foundation/dictionary-category/read.ftl页面
	 * 
	...
	public String read(HttpServletRequest request) {
		...
		return "/security/foundation/dictionary-category/read";
		
	}
	
	/**
	 * 通过主键id集合删除字典类别,删除成功后重定向到:security/foundation/dictionary-category/view
	 * 
	 * @param ids 主键id集合
	 * @param redirectAttributes spring mvc 重定向属性
	 * 
