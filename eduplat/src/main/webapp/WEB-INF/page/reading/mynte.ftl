	...
	<div class="row-fluid">
		<div class="span3">
			...
			<ul class="nav nav-pills nav-stacked">
			  ...
			  <li class="active"><a href="mynte"><i class="icon-facetime-video"></i> 我的笔记</a></li>
		...
		<div class="span9">
			...
			<#if page.content??>
				...
				<div class="tlst">
					<div class="nlst">
						<h3><div class="rr"><a href="deleteNte?cmtId=${e.id}">×</a></div><a href="#">${fkBookId!'--'}</a></h3>
					</div>
					<div class="clst">
			...
			<ul class="pager">
				<#if page.hasPreviousPage()>
			    	<li><a href="mynte?page.page=0">首页</a></li>
			    	<li><a href="mynte?page.page=${page.number - 1}">上一页</a></li>
		        </#if>
		        <#if page.hasNextPage()>
		        	<li><a href="mynte?page.page=${page.number + 1}">下一页</a></li>
			    	<li><a href="mynte?page.page=${page.totalPages - 1}">尾页</a></li>
		        </#if>
			</ul>
			</#if>
		</div>
