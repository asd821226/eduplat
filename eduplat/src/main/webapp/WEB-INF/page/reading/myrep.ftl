	...
	<div class="row-fluid">
		<div class="span3">
			...
			<ul class="nav nav-pills nav-stacked">
			  ...
			  <li class="active"><a href="myrep"><i class="icon-list"></i> 我的回应</a></li>
			</ul>
		</div>
		<div class="span9">
			<ul class="breadcrumb">
			...
			<#if page.content??>
				...
				<div class="tlst">
					<div class="nlst">
						<h3><div class="rr"><a href="deleteRep?cmtId=${e.id}">×</a></div><a href="#">${fkBookId!'--'}</a></h3>
					</div>
					<div class="clst">
			...
			<ul class="pager">
				<#if page.hasPreviousPage()>
			    	<li><a href="myrep?page.page=0">首页</a></li>
			    	<li><a href="myrep?page.page=${page.number - 1}">上一页</a></li>
		        </#if>
		        <#if page.hasNextPage()>
		        	<li><a href="myrep?page.page=${page.number + 1}">下一页</a></li>
			    	<li><a href="myrep?page.page=${page.totalPages - 1}">尾页</a></li>
		        </#if>
			</ul>
			</#if>
		</div>
