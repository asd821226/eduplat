...
<script>
	$(document).ready(function(){
		...
		$("#selectAll").click(function(){
			var checks = $("#book_list tbody").find("input[type='checkbox'][id!='selectAll']");
...
<div id="book_panel">
	...
	<div class="panel_title">
	 	<span class="user24_icon">图书管理</span>
	</div>
	...
	<div class="panel_content">
	  ...
	  <form id="delete_form" action="finance/book/delete" method="post">
		  <table width="100%" id="book_list">
		    	<thead>
		        	<tr>
		        		<th>
		        ...
		        <tbody>
		        	<#list page.content as e>
		            	<tr>
		                    ...
		                    <td align="center">
		                    	<@shiro.hasPermission name="book:read">
		                    		<a href="finance/book/read?id=${e.id}" icon="user24_icon"  width="610" target="dialog" dialogId="update_book" modal="true" title="修改学生/${e.name}" class="operat edit16_icon">
		                    	</@shiro.hasPermission>
		                    </td>
		                </tr>
		            </#list>
	...
	<div class="panel_footer">
		<@shiro.hasPermission name="book:save">
			<a href="finance/book/read" icon="user24_icon" width="610" target="dialog" dialogId="create_book" modal="true" title="添加用户">
				<span class="button left">添 加</span>
			</a>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="book:delete">
	    	<a href="javascript:$.form.submitMaskForm('#delete_form',{maskEl:'#book_panel',target:'#main_content',promptMsg:'确定要删除吗?'})" title="删除选中用户">
	    		<span class="button left">删 除</span>
	    	</a>
	    </@shiro.hasPermission>
	    <a href="#search_book_dailog" width="610" icon="user24_icon" target="dialog" dialogId="search_dailog" title="查询学生列表">
