...
(function($) {
	...
	$.fn.raty = function(settings) {
		...
		// TODO: Using var for values that will be used into a function later (bind/bind), to keep the current value and not the last one. Why, Mr. Anderson? Why? 
	...
	function bindEnter() {
		var id = $this.attr('id');
		$('img.' + id).bind('mouseenter', function() {
